...
function App() {
  const baseUrl="http://localhost/apibanco/";
  ...
  const peticionPost=async()=>{
    ...
    f.append("ndecaja", frameworkSeleccionado.ndecaja);
    f.append("arqueo", frameworkSeleccionado.arqueo);
    ...
    .then(response=>{
      ...
      dataNueva.map(framework=>{
        if(framework.id===frameworkSeleccionado.id){
          ...
          framework.ndecaja=frameworkSeleccionado.ndecaja;
          framework.arqueo=frameworkSeleccionado.arqueo;
        }
      });
      setData(dataNueva);
      ...
      <tbody>
        {data.map(framework=>(
          <tr key={framework.id}>
            ...
            <td>{framework.ndecaja}</td>
            <td>{framework.arqueo}</td>
          <td>
    ...
    <Modal isOpen={modalInsertar}>
      ...
      <ModalBody>
        <div className="form-group">
          ...
          <label>ndecaja: </label>
          <br />
          <input type="text" className="form-control" name="consulta" onChange={handleChange}/>
          <br />
          <label>arqueo: </label>
          <br />
          <input type="text" className="form-control" name="banco" onChange={handleChange}/>
          <br />
        </div>
      </ModalBody>
      <ModalFooter>
    ...
    <Modal isOpen={modalEditar}>
      ...
      <ModalBody>
        <div className="form-group">
          ...
          <label>apellido: </label>
          <br />
          <input type="text" className="form-control" name="apellido" onChange={handleChange} value={frameworkSeleccionado && frameworkSeleccionado.edad}/>
          <br />
          <label>ndecaja: </label>
          <br />
          <input type="text" className="form-control" name="ndecaja" onChange={handleChange} value={frameworkSeleccionado && frameworkSeleccionado.consulta}/>
          <br />
          <label>arqueo: </label>
          <input type="text" className="form-control" name="arqueo" onChange={handleChange} value={frameworkSeleccionado && frameworkSeleccionado.consulta}/>
          <br />
        </div>
      </ModalBody>
      <ModalFooter>
